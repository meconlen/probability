...
\begin{definition}[Categorial Distribution]\index{categorial distribution}\index{distribution!categorial}
...
\begin{remark}[Multinomial]\index{multinomial}
...
\begin{definition}[Multinomial Coefficient]\index{multinomial coefficient}
...
\begin{definition}[Multinomial Distribution]\index{multinomial distribution}
...
\begin{definition}[Conditional Probability Mass Function]\index{conditional probability mass function}\index{probability mass function!conditional}
...
\begin{definition}[Conditional Cumulative Distribution Function]\index{conditional cumulative distribution function}\index{cumulative distribution function!conditional}
...
\begin{definition}[Discrete Conditional Expectation]\index{expectation!discrete conditional}\index{discrete conditional expectation}
...
\begin{definition}[Conditional Probability Distribution Function]\index{conditional probability distribution function}\index{probability distribution function!conditional}
...
\begin{definition}[Continuous Conditional Expectation]\index{expectation!continuous conditional}\index{continuous conditional expectation}
	The \emph{conditional expectation} of $X$ given that $Y=y$ is given by 
	\begin{alignat}{4}
...
\begin{definition}[Conditional Expectation]\index{expectation!conditional}
...
\begin{definition}[Compound Random Variable]\index{random variable!compound}\index{compound random variable}\index{compounding distribution}
